...
EventEmitter.prototype.removeListener = function (a, b) {
  "object" === typeof this.events[a] &&
    ((b = indexOf(this.events[a], b)), -1 < b && this.events[a].splice(b, 1));
};
...
HudsonWorkspace.prototype.load =
  function (a, b, c) {
    b = void 0 === b ? !1 : b;
    c = void 0 === c ? 0 : c;
    this.destroyed ||
...
HudsonWorkspace.prototype.getCurrentTime =
  function () {
    return (this._ready && this._player.getCurrentTime()) || 0;
  };
HudsonWorkspace.prototype.destroy =
  function () {
    this._destroy();
  };
HudsonWorkspace.prototype._destroy =
  function (a) {
    this.destroyed ||
      ((this.destroyed = !0),
      this._player &&
...
HudsonWorkspace.prototype._queueCommand =
  function (a, b) {
    for (var c = [], d = 1; d < arguments.length; ++d) c[d - 1] = arguments[d];
    this.destroyed || this._queue.push([a, c]);
  };
HudsonWorkspace.prototype._flushQueue =
  function () {
...
HudsonWorkspace.prototype._loadIframeAPI =
  function (a) {
...
HudsonWorkspace.prototype._createPlayer =
  function (a) {
    var b = this;
    if (!this.destroyed) {
      var c = this._opts;
...
HudsonWorkspace.prototype._onReady =
  function (a) {
    this.destroyed ||
      ((this._ready = !0),
...
HudsonWorkspace.prototype._onStateChange =
  function (a) {
    if (!this.destroyed) {
...
HudsonWorkspace.prototype._onPlaybackQualityChange =
  function (a) {
    this.destroyed || this.emit("playbackQualityChange", a.data);
  };
HudsonWorkspace.prototype._onPlaybackRateChange =
  function (a) {
    this.destroyed || this.emit("playbackRateChange", a.data);
  };
HudsonWorkspace.prototype._onError =
  function (a) {
...
HudsonWorkspace.prototype._onTimeupdate =
  function () {
    this.emit("timeupdate", this.getCurrentTime());
  };
HudsonWorkspace.prototype._startInterval =
  function () {
    var a = this;
...
HudsonWorkspace.prototype._stopInterval =
  function () {

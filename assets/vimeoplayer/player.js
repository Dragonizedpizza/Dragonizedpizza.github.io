...
$jscomp.arrayIteratorImpl = function (c) {
	var g = 0;
	return function () {
		return g < c.length ? { done: !1, value: c[g++] } : { done: !0 };
	};
};
...
$jscomp.polyfill(
	...
	function (c) {
		...
		function f(m) {
			if (!$jscomp.owns(m, b)) {
				var e = new k();
				$jscomp.defineProperty(m, b, { value: e });
			}
		}
		function p(b) {
			var e = Object[b];
		...
		n.prototype.set = function (e, c) {
			...
			f(e);
			if (!$jscomp.owns(e, b)) throw Error("WeakMap key fail: " + e);
			e[b][this.id_] = c;
			return this;
		};
...
$jscomp.polyfill(
	...
	function (c) {
		...
		f.race = function (b) {
			return new f(function (e, c) {
				for (
					var f = $jscomp.makeIterator(b), g = f.next();
					!g.done;
					g = f.next()
				)
					k(g.value).callWhenSettled_(e, c);
			});
		};
		f.all = function (b) {
			...
			return c.done
				...
				: new f(function (b, f) {
						...
						do
							l.push(void 0),
								m++,
								k(c.value).callWhenSettled_(g(l.length - 1), f),
								(c = e.next());
						while (!c.done);
				  });
		};
...
(function (c, g) {
	...
	function k(b, a) {
		return 0 === b.indexOf(a.toLowerCase())
			...
			: ""
					...
					.concat(b.substr(0, 1).toUpperCase())
					.concat(b.substr(1));
	}
	function l(b) {
	...
	function f() {
		...
		if (!isNaN(parseFloat(b)) && isFinite(b) && Math.floor(b) == b)
			return "https://vimeo.com/".concat(b);
		if (l(b)) return b.replace("http:", "https:");
		if (a)
			throw new TypeError(
				"\u201c".concat(a, "\u201d is not a valid video id.")
			);
		throw new TypeError(
			"\u201c".concat(b, "\u201d is not a vimeo.com url.")
		);
	}
	function p(b, a, d) {
	...
	function w(b, a) {
		...
		if (null !== a.getAttribute("data-vimeo-initialized"))
	...
	function B(b) {
		...
		return new Promise(function (h, c) {
			...
			for (f in a)
				a.hasOwnProperty(f) &&
					(e += "&".concat(f, "=").concat(encodeURIComponent(a[f])));
			var g =
			...
			g.onload = function () {
				if (404 === g.status)
					c(Error("\u201c".concat(b, "\u201d was not found.")));
				else if (403 === g.status)
					c(Error("\u201c".concat(b, "\u201d is not embeddable.")));
				else
					try {
						var a = JSON.parse(g.responseText);
						403 === a.domain_status_code
							? (w(a, d),
							  c(
									Error(
										"\u201c".concat(
	...
	function C() {
		var b = function (a) {
			"console" in window &&
				console.error &&
				console.error(
					"There was an error creating an embed: ".concat(a)
				);
		};
		[].slice
			.call(
		...
		window.VimeoPlayerResizeEmbeds_ ||
			...
			window.addEventListener("message", function (a) {
				if (l(a.origin) && a.data && "spacechange" === a.data.event)
					for (
						var d = b.querySelectorAll("iframe"), c = 0;
						c < d.length;
						c++
					)
						if (d[c].contentWindow === a.source) {
							d[c].parentElement.style.paddingBottom = "".concat(
	...
	function u(b, a, d) {
		b.element.contentWindow &&
			...
			8 <= d && 10 > d && (a = JSON.stringify(a)),
			b.element.contentWindow.postMessage(a, b.origin));
	}
	function K(c, a) {
		a = D(a);
		var d = [];
		if (a.event) {
			"error" === a.event &&
				b(c, a.data.method).forEach(function (b) {
	...
	function L() {
		var b = (function () {
			...
			d = {
				...
				off: function (b, d) {
					(b = a[b]) && document.removeEventListener(b, d);
				},
			};
			...
			(function (a, d, c) {
				...
				n(m, "reject", function (a) {
					return new this(function (b, d) {
						if ("function" != typeof b || "function" != typeof d)
							throw TypeError("Not a function");
						d(a);
					});
				});
	...
	y = (function () {
		function c(a) {
			...
			if ("IFRAME" === a.nodeName && !l(a.getAttribute("src") || ""))
				throw Error(
			...
			g = new t(function (d, c) {
				b._onMessage = function (a) {
					if (l(a.origin) && b.element.contentWindow === a.source)
						if (
			...
			if (q.isEnabled) {
				...
				q.on("fullscreenchange", function () {
					q.isFullscreen
						? p(b, "event:exitFullscreen", k)
						: e(b, "event:exitFullscreen", k);
		...
		g(c, [
			...
			},
			{
				...
				value: function (a, c) {
					...
					0 === b(this, "event:".concat(a)).length &&
						this.callMethod("addEventListener", a).catch(
							function () {}
						);
			...
			},
			{
				...
				value: function (a, b) {
					...
					if (b && "function" !== typeof b)
						throw new TypeError("The callback must be a function.");
					e(this, "event:".concat(a), b) &&
						this.callMethod("removeEventListener", a).catch(
							function (a) {}
						);
				},
			},
			...
			},
			{
				...
				value: function () {
					...
					return new t(function (b) {
						...
						v.delete(a.element);
						a._originalElement &&
							(v.delete(a._originalElement),
							a._originalElement.removeAttribute(

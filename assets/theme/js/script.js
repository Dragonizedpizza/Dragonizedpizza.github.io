		...
		return b
			...
			: function (b, d) {
					return (
						-1 !==
						$jscomp
							.checkStringArgs(this, b, "includes")
							.indexOf(b, d || 0)
					);
			  };
	},
...
(function () {
	...
	(function (a) {
		...
		window[a] = function (c) {
			...
			return c
				? this.addEventListener("resize", b(c))
	...
	l(function () {
						...
						if (c && /youtu\.?be/g.test(c[3])) {
							...
							f.onload = function () {
								...
								a.querySelector(".mbr-background-video") &&
									a
										.querySelector(".mbr-background-video")
										.remove();
		...
		document
			.querySelector("html")
			.classList.add(w() ? "mobile" : "desktop");
	...
	if (!m) {
		...
		if (r)
			h(document).on("add.cards", function (a) {
				a.target.classList.contains("mbr-reveal") &&
					a.target.footerReveal();
			});
		l(function () {
			if (
				!w() &&
					...
					b = function (a) {
						if (
							a.parents(".carousel-item").some(function (a) {
								return (
									"none" !== getComputedStyle(a, null).display
								);
							})
						)
							return !1;
	...
	if (
		...
		h(document).on("add.cards", function (a) {
			...
			b.classList.contains("mbr-fullscreen") &&
				((a = function () {
					b.style.height = "auto";
					b.offsetHeight <= window.innerHeight &&
						(b.style.height = "1px");
				}),
	...
	m ||
		...
		"undefined" === typeof window.initPopupBtnPlugin &&
			0 !=
				document.body.querySelectorAll("section.popup-btn-cards")
					.length &&
		...
		"undefined" === typeof window.initTestimonialsPlugin &&
			0 !=
				document.body.querySelectorAll(".testimonials-slider").length &&
		...
		0 != document.querySelectorAll(".mbr-slider.carousel").length &&
			document
				.querySelectorAll(".mbr-slider.carousel")
				.forEach(function (a) {
					...
					a.addEventListener("slid.bs.carousel", function () {
						...
						1 <
							a.querySelectorAll(".carousel-item.active")
								.length &&
							(a
